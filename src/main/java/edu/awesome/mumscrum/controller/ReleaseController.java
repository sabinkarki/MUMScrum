...
public class ReleaseController {
	...
	public String newRelease(@PathVariable long productId,Model model) {
	...
	public String newRelease(@PathVariable long productId,@Valid Release release, BindingResult result, ModelMap model) {
		model.addAttribute("selectedProductId",productId);
